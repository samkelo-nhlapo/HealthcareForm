-- V6__create_clients_entity.sql
-- Adds standalone Profile.Clients entity with optional link to Profile.Patient.
...
AND OBJECT_ID(N'FK_Clients_Patient', N'F') IS NULL
BEGIN
...
AND OBJECT_ID(N'FK_Clients_Address', N'F') IS NULL
BEGIN
    ALTER TABLE [Profile].[Clients] WITH CHECK
...
IF OBJECT_ID(N'[Profile].[Clients]', N'U') IS NOT NULL
AND NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[Profile].[Clients]') AND name = N'UX_Clients_PatientIdFK')
BEGIN
...
IF OBJECT_ID(N'[Profile].[Clients]', N'U') IS NOT NULL
AND NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[Profile].[Clients]') AND name = N'IX_Clients_ClientCode')
BEGIN
...
IF OBJECT_ID(N'[Profile].[Clients]', N'U') IS NOT NULL
AND NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[Profile].[Clients]') AND name = N'IX_Clients_LastName')
BEGIN
...
IF OBJECT_ID(N'[Profile].[Clients]', N'U') IS NOT NULL
AND NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[Profile].[Clients]') AND name = N'IX_Clients_IsDeleted')
BEGIN
...
IF OBJECT_ID(N'[Profile].[Clients]', N'U') IS NOT NULL
AND NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[Profile].[Clients]') AND name = N'IX_Clients_IsActive')
BEGIN
